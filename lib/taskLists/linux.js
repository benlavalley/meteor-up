...
exports.setup = function(config) {
  ...
  taskList.copy('Configuring systemd', {
    ...
    vars: {
      ...
      restartOptions: config.restartOptions,
    }
  });

  //set systemd service to auto start
  taskList.execute('systemd - set service to auto-run', {
	command: `(sudo systemctl enable ${config.appName}.service)`
  });
...
exports.deploy = function(bundlePath, env, deployCheckWaitTime, appName, enableUploadProgressBar, enableSharpBinaryFix, noBundleDelete, noBackupCurrentApp) {
  ...
  taskList.executeScript('Invoking deployment process', {
    ...
    vars: {
      enableSharpBinaryFix: enableSharpBinaryFix || 'no',
	  noBundleDelete: noBundleDelete || 'no',
      noBackupCurrentApp: noBackupCurrentApp || 'no',
