...
exports.read = function() {
  ...
  if(fs.existsSync(mupJsonPath)) {
    ...
    if(typeof mupJson.enableSharpBinaryFix === "undefined") {
	  mupJson.enableSharpBinaryFix = "no";
    }
    if(typeof mupJson.noBundleDelete === "undefined") {
        mupJson.noBundleDelete = "no";
    }

    if(typeof mupJson.noBackupCurrentApp === "undefined") {
      mupJson.noBackupCurrentApp = "yes";
    }
    //validating servers
